...
4. Name it **Emirates Pride** → tap **Add**
5. The app icon appears on the iPad home screen — tap to open like any app

> Works fully offline after first load. All data saved on the device.
